...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      body(
        "Performance Engineer with 28+ years of experience across government, telecom, banking, and logistics. Expert in LoadRunner (VuGen/LRE) with 14 years of production experience. Trained in JMeter and NeoLoad. Proficient in Agile/Scrum, AWS, Kubernetes, and observability tools (Splunk, AppDynamics, Prometheus, Grafana). Built a real-world AI-powered automation system using Python and the Claude API. Actively pursuing AI engineering. Open to remote contract and full-time roles."
      ),
      ...
      body(
        "LoadRunner / VuGen / LRE (14 yrs)  •  JMeter (trained)  •  NeoLoad (trained)  •  Performance & Load Testing  •  Workload Modeling  •  SLA Compliance  •  Agile/Scrum  •  AWS  •  Kubernetes  •  CI/CD  •  Splunk  •  AppDynamics  •  Prometheus  •  Grafana  •  REST APIs  •  SQL  •  Python  •  AI Agent Development  •  Prompt Engineering  •  Root Cause Analysis  •  Selenium"
      ),
